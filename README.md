...
```sh
sh -c "$(curl -fsSL https://github.com/bitcoin-tools/nodebuilder/raw/v1.11.0/nodebuilder)"
```
...
```sh
wget https://github.com/bitcoin-tools/nodebuilder/raw/v1.11.0/nodebuilder
...
|:-----:|:-------------|:------------|:----------|
| `-b` | `--bitcoin-version` | Specify the Bitcoin version. | One argument<br>E.g.: `-b 29.0` |
...
You can set multiple options. Here are two ways to compile Bitcoin 29.0 unattended with a 50000 MiB prune:

```sh
./nodebuilder -b 29.0 -c -p 50000 -u
./nodebuilder --bitcoin-version 29.0 --compile --prune 50000 --unattended
```
