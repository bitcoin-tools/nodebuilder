...
```sh
sh -c "$(curl -fsSL https://github.com/bitcoin-tools/nodebuilder/raw/v2.3.0-beta/nodebuilder)"
```
...
```sh
wget https://github.com/bitcoin-tools/nodebuilder/raw/v2.3.0-beta/nodebuilder
...
|:-----:|:-------------|:------------|:----------|
| `-b` | `--bitcoin-version` | Specify the Bitcoin version. | One argument<br>E.g.: `-b 31.1` |
...
You can set multiple options. Here are two ways to compile Bitcoin 31.1 unattended with a 50000 MiB prune:

```sh
./nodebuilder -b 31.1 -c -p 50000 -u
./nodebuilder --bitcoin-version 31.1 --compile --prune 50000 --unattended
```
