...
```sh
sh -c "$(curl -fsSL https://github.com/bitcoin-tools/nodebuilder/raw/v1.7.1-beta.2/nodebuilder)"
```
...
```sh
wget https://github.com/bitcoin-tools/nodebuilder/raw/v1.7.1-beta.2/nodebuilder
