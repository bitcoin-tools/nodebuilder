...
3. A compatible operating system:
   ...
   - [SUSE](https://documentation.suse.com/sles/) Linux or any derivative like [openSUSE Leap](https://doc.opensuse.org/documentation/leap/startup/html/book-startup/art-opensuse-installquick.html)
